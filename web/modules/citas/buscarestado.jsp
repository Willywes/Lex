<%-- 
    Document   : buscarestado
    Created on : 15-06-2019, 14:30:01
    Author     : claudio
--%>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="citas" items="${citas}"> 
                                    <tr>
                                        ...
                                        <td>${citas.getId_notaria()}</td>          
                                        <td>${citas.getId_estado_cita()}</td>
