 ...
 * @author claudio
 */
@WebServlet(name = "SolicitudVerUsuario", urlPatterns = {"/solicitudes/versolicitudusuario"})

public class SolicitudVerUsuario extends HttpServlet {
private final SolicitudDAO solicitudDAO = new SolicitudDAO();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SolicitudVerUsuario</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SolicitudVerUsuario at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       request.getRequestDispatcher("/modules/solicitudes/detalleusuario.jsp").forward(request, response);
    }
