 ...
 * @author claudio
 */
@WebServlet(name = "SolicitudBorrar", urlPatterns = {"/solicitudes/listarcliente"})
public class SolicitudListarCliente extends HttpServlet {
private final SolicitudDAO solicitudDAO = new SolicitudDAO();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SolicitudListarCliente</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SolicitudListarCliente at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       request.setAttribute("usuarioDTO", usuarioDTO);
        ...
        request.getRequestDispatcher("/modules/solicitudes/listarusuario.jsp").forward(request, response);
    }
